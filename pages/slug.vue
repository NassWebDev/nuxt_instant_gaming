      ...
      <div class="details-container">
        ...
        <div v-else class="details">
          ...
          <div class="gallery">
            ...
            <ul class="list">
              <li v-for="(image, index) in gamesInfo?.allImages" :key="index" @click="showCarousel(index)">
                <img :src="image.image" alt="">
              </li>
            </ul>
          </div>
          <div class="requirements-container" v-if="gameInfo?.requirements">
            <h2>
              Requirements
            </h2>
              ...
              <div class="images-container">
                <Carousel v-model="currentSlide">
                  ...
                  <div class="thumbs-container">
                    <ul class="thumber">
                      <li v-for="(image, index) in gameImages" :key="index" @click="slideTo(index)">
...
const { data: gameImages } = await useFetch(`https://api.rawg.io/api/games/red-dead-redemption-2/screenshots`, {
    method: "GET",
    headers:{
        "Content-Type": "application/json",
        "token": `Token ${import.meta.env.VITE_ACCESS_TOKEN}`,
...
for (let i = 0; i < gameInfo.allImages.length; i++) {
  console.log(gameInfo.allImages[i].image);
}
